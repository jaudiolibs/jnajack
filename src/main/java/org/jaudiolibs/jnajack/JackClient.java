 ...
 * Portions copyright 2017 Matthew MacLeod
...
public class JackClient {
	...
	public JackPort registerPort(String name, JackPortType type, EnumSet<JackPortFlags> flags) throws JackException {
		...
		try {
			portPtr = jackLib.jack_port_register(clientPtr, name, typeString, nativeFlags, bufferSize);
		} catch (Throwable e) {
			LOG.log(Level.SEVERE, CALL_ERROR_MSG, e);
			portPtr = null;
		}
	...
	public void setGraphOrderCallback(JackGraphOrderCallback callback) throws JackException {
		...
		try {
			jackLib.jack_set_graph_order_callback(clientPtr,
					graphOrderChangeCallback = new GraphOrderCallbackWrapper(callback), null);
		} catch (Throwable e) {
			LOG.log(Level.SEVERE, CALL_ERROR_MSG, e);
		}
	}
	...
	public void setClientRegistrationCallback(JackClientRegistrationCallback callback) throws JackException {
		...
		try {
			jackLib.jack_set_client_registration_callback(clientPtr,
					clientRegistrationCallback = new ClientRegistrationCallbackWrapper(callback), null);
		} catch (Throwable e) {
			LOG.log(Level.SEVERE, CALL_ERROR_MSG, e);
		}
	}
	...
	public void setPortConnectCallback(JackPortConnectCallback callback) throws JackException {
		...
		try {
			jackLib.jack_set_port_connect_callback(clientPtr,
					portConnectCallback = new PortConnectCallbackWrapper(callback), null);
		} catch (Throwable e) {
			LOG.log(Level.SEVERE, CALL_ERROR_MSG, e);
		}
	}
	...
	public void setPortRegistrationCallback(JackPortRegistrationCallback callback) throws JackException {
		...
		try {
			jackLib.jack_set_port_registration_callback(clientPtr,
					portRegistrationCallback = new PortRegistrationCallbackWrapper(callback), null);
		} catch (Throwable e) {
			LOG.log(Level.SEVERE, CALL_ERROR_MSG, e);
		}
	}
		...
		public int invoke(int nframes) {
			...
			try {
				...
				for (JackPort port : pts) {
					Pointer ptr = jackLib.jack_port_get_buffer(port.portPtr, nframes);
