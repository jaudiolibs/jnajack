...
public interface JackLibrary extends com.sun.jna.Library {
	...
	public static class jack_position_t extends com.sun.jna.Structure {
		...
		protected List getFieldOrder() {
			return Arrays.asList(new String[] { "unique_1", "usecs", "frame_rate", "frame", "valid", "bar", "beat",
					"tick", "bar_start_tick", "beats_per_bar", "beat_type", "ticks_per_beat", "beats_per_minute",
					"frame_time", "next_time", "bbt_offset", "audio_frames_per_video_frame", "video_offset", "padding",
					"unique_2" });
		}
	}
...
//		@Override
//		protected List getFieldOrder() {
//			return Arrays.asList(new String[] { "frame_rate", "usecs", "valid", "transport_state", "frame",
//					"loop_start", "loop_end", "smpte_offset", "smpte_frame_rate", "bar", "beat", "tick",
//					"bar_start_tick", "beats_per_bar", "beat_type", "ticks_per_beat", "beats_per_minute" });
//		}
//	}
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z29jack_set_thread_init_callbackP12_jack_client22JackThreadInitCallbackPv", "?jack_set_thread_init_callback@@YAHPA12_jack_client22JackThreadInitCallbackPAX@Z"})
	int jack_set_thread_init_callback(_jack_client client, JackThreadInitCallback thread_init_callback,
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z27jack_set_freewheel_callbackP12_jack_client21JackFreewheelCallbackPv", "?jack_set_freewheel_callback@@YAHPA12_jack_client21JackFreewheelCallbackPAX@Z"})
	int jack_set_freewheel_callback(_jack_client client, JackFreewheelCallback freewheel_callback,
			com.sun.jna.Pointer arg);
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z29jack_set_buffer_size_callbackP12_jack_client22JackBufferSizeCallbackPv", "?jack_set_buffer_size_callback@@YAHPA12_jack_client22JackBufferSizeCallbackPAX@Z"})
	int jack_set_buffer_size_callback(_jack_client client, JackBufferSizeCallback bufsize_callback,
			com.sun.jna.Pointer arg);
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z29jack_set_sample_rate_callbackP12_jack_client22JackSampleRateCallbackPv", "?jack_set_sample_rate_callback@@YAHPA12_jack_client22JackSampleRateCallbackPAX@Z"})
	int jack_set_sample_rate_callback(_jack_client client, JackSampleRateCallback srate_callback,
			com.sun.jna.Pointer arg);
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z37jack_set_client_registration_callbackP12_jack_client30JackClientRegistrationCallbackPv", "?jack_set_client_registration_callback@@YAHPA12_jack_client30JackClientRegistrationCallbackPAX@Z"})
	int jack_set_client_registration_callback(_jack_client jack_client_tPtr1,
			JackClientRegistrationCallback registration_callback, com.sun.jna.Pointer arg);
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z35jack_set_port_registration_callbackP12_jack_client28JackPortRegistrationCallbackPv", "?jack_set_port_registration_callback@@YAHPA12_jack_client28JackPortRegistrationCallbackPAX@Z"})
	int jack_set_port_registration_callback(_jack_client jack_client_tPtr1,
			JackPortRegistrationCallback registration_callback, com.sun.jna.Pointer arg);
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z30jack_set_port_connect_callbackP12_jack_client23JackPortConnectCallbackPv", "?jack_set_port_connect_callback@@YAHPA12_jack_client23JackPortConnectCallbackPAX@Z"})
	int jack_set_port_connect_callback(_jack_client jack_client_tPtr1, JackPortConnectCallback connect_callback,
			com.sun.jna.Pointer arg);
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z29jack_set_graph_order_callbackP12_jack_client22JackGraphOrderCallbackPv", "?jack_set_graph_order_callback@@YAHPA12_jack_client22JackGraphOrderCallbackPAX@Z"})
	int jack_set_graph_order_callback(_jack_client jack_client_tPtr1, JackGraphOrderCallback graph_callback,
...
//	// @com.ochafik.lang.jnaerator.Mangling({"_Z18jack_port_registerP12_jack_clientPKcPKcmm", "?jack_port_register@@YAPA10_jack_portPA12_jack_clientPADPADKK@Z"})
	_jack_port jack_port_register(_jack_client client, java.lang.String port_name, java.lang.String port_type,
			com.sun.jna.NativeLong flags, com.sun.jna.NativeLong buffer_size);
...
//    int jack_port_get_aliases(_jack_port port, java.nio.ByteBuffer aliases[]);
	...
	int jack_disconnect(_jack_client jack_client_tPtr1, java.lang.String source_port,
...
//    com.sun.jna.ptr.PointerByReference jack_get_ports(_jack_client jack_client_tPtr1, java.lang.String port_name_pattern, java.lang.String type_name_pattern, com.sun.jna.NativeLong flags);
	Pointer jack_get_ports(_jack_client jack_client_tPtr1, java.lang.String port_name_pattern,
			java.lang.String type_name_pattern, com.sun.jna.NativeLong flags);
...
//    void free(Pointer ptr);
	...
	public static class jack_latency_range_t extends com.sun.jna.Structure {
		...
		public static class ByReference extends jack_latency_range_t implements com.sun.jna.Structure.ByReference {
		...
		public static class ByValue extends jack_latency_range_t implements com.sun.jna.Structure.ByValue {
	 ...
	 * @return
	 */
	int jack_get_current_transport_frame(_jack_client client);
	 ...
	 * @return 0 on success, otherwise a non-zero error code.
	 */
	int jack_set_sync_callback(_jack_client client, JackSyncCallback sync_callback, Pointer arg);
	 ...
	 * @return 0 on success, otherwise a non-zero error code.
	 */
	int jack_set_sync_timeout(_jack_client client, long timeout);
	 ...
	 */
	int jack_set_timebase_callback(_jack_client client, int conditional, JackTimebaseCallback timebase_callback,
			Pointer arg);
	 ...
	 */
	int jack_transport_locate(_jack_client client, int frame);
	 ...
	 */
	int jack_transport_query(_jack_client client, jack_position_t pos);
	 ...
	 */
	int jack_transport_reposition(_jack_client client, jack_position_t pos);
	 ...
	 * @param client the JACK client structure.
	 */
	void jack_transport_start(_jack_client client);
...
//	 */
//	void jack_get_transport_info (_jack_client client,
...
//	 */
//	void jack_set_transport_info (_jack_client client,
//				      jack_transport_info_t tinfo);
